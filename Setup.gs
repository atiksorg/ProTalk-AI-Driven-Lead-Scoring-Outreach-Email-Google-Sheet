...
function setupSheets() {
  ...
  createSheet(ss, SHEET_CONFIG, ["Параметр", "Значение", "Описание"], [
    ...
    ["TEST_EMAIL", "", "Email для отладки (если заполнен, все письма идут на него)"],
    ...
    ["ENABLE_FOLLOWUPS", "0", "Включить фоллоу-апы (1 - вкл, 0 - выкл). Вкл = тратит 2 квоты на 1 письмо."],
    ["FAKE_MAIL_SEND", "0", "Фейковая отправка (1 - вкл, 0 - выкл). Если 1, письма не отправляются, но пишутся в SEND_LOG."],
  ...
  createSheet(ss, SHEET_QUERIES,
    ["ID Кампании", "Поисковый запрос", "Страна", "Кол-во результатов", "Начальная позиция", "Статус"], [
    ["CAMP_01", "купить подстанцию ктп в таганроге от производителя", "ru", "10", "0", "active"],
    ["CAMP_01", "бетонные наливные полы Владивосток смета", "ru", "10", "0", "active"],
    ["CAMP_01", "установка сигнализаций в офисе Санкт-Петербург", "ru", "10", "0", "active"]
  ]);
  ...
  createSheet(ss, SHEET_SEND_LOG, ["Дата", "Статус", "Кампания", "Email", "Тема", "Текст письма", "Модель ИИ", "Промпт ИИ", "Режим ИИ", "Thread ID", "Ошибка"], []);
